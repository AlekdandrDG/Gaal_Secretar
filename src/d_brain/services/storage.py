...
class VaultStorage:
    """Service for storing entries in хранилище мыслей."""
    ...
    def save_attachment(
        ...
        """Save attachment and return relative path for хранилище мыслей embed.
        ...
        Returns:
            Relative path for хранилище мыслей embed: attachments/YYYY-MM-DD/img-HHMMSS.ext
        """
